"""FAST training for TAKE_COVER (simplest scenario).
...
# Configuration
SCENARIO = "take_cover"
TOTAL_TIMESTEPS = 5_000_000  # Should learn quickly
N_ENVS = 16
LEARNING_RATE = 3e-4
BATCH_SIZE = 512
N_STEPS = 256
...
GAE_LAMBDA = 0.95
CLIP_RANGE = 0.2
ENT_COEF = 0.01  # Low exploration (simple problem)
VF_COEF = 0.5
MAX_GRAD_NORM = 0.5
CHECKPOINT_FREQ = 250_000  # More frequent for faster scenario
...
def main():
    print("=" * 60)
    print("FAST TRAINING - TAKE COVER (EASIEST SCENARIO)")
    print("=" * 60)
    ...
    print("  Starting: ~50-100 reward (random dodging)")
    print("  After 500k: ~500-1000 reward (learning patterns)")
    print("  After 2M: ~1500+ reward (mastery)")
    print("\nThis should learn MUCH faster than deadly corridor!")
    print()
