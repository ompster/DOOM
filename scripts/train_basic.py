"""Training script for VizDoom BASIC scenario."""
import os
import sys
...
# Configuration
SCENARIO = "basic"
TOTAL_TIMESTEPS = 2_000_000  # 2 million steps (more learning time)
N_ENVS = 16  # Fewer parallel envs = more steps per environment
LEARNING_RATE = 3e-4
BATCH_SIZE = 256
...
ENT_COEF = 0.02  # Higher entropy = MORE exploration (doubled)
...
def main():
    """Main training loop."""
    print("=" * 60)
    print(f"Training VizDoom - {SCENARIO.upper()} Scenario")
    print("=" * 60)
